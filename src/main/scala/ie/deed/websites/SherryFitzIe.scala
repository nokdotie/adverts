...
private case class PropertiesApiResponse(
...
private case class PropertiesApiResponseFeature(
...
private case class PropertiesApiResponseFeatureProperty(link: String)
...
private val getPropertiesApiLinks =
  ZStream
    .iterate(1)(_ + 1)
    .map { page =>
